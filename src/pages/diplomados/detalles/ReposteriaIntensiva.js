...
const ReposteriaIntensiva = () => {
  ...
  return (
    <main>
      ...
      <DiplomadosDetalle titulo={"Diplomado de Reposteria Intensivo"} duracion={"8 clases"} clases={["Galletería fina", "Macarons", "Pan dulce mexicano", "Pan salado", "Mousses y bavaresas", "Pastelería moderna", "Fondant", "Chocolatería 2do nivel"]} duracionClase={"4 horas"} portada={"/images/diplomados/reposteriaIntensivo.jpg"} />
