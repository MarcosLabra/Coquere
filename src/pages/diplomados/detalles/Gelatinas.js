...
const Gelatinas = () => {
  ...
  return (
    <main>
      ...
      <DiplomadosDetalle  titulo={"Diplomado Básico de Repostería"} duracion={"4 clases"} clases={["Gelatinas a base de aguas y frutas", "Gelatinas a base de leche y yogurth", "Gelatinas - encapsulado", "Gelatinas temáticas (2 clases)"]} duracionClase={" 3 horas"} portada={"/images/diplomados/gelatinas.png"} />
