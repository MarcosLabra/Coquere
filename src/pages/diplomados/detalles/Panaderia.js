...
const Panaderia = () => {
  ...
  return (
    <main>
      ...
      <DiplomadosDetalle titulo={"Diplomado de Panadería"} duracion={"5 clases"} clases={["Pan dulce y laminado", "Pan para restaurantes", "Pan dulce mexicano", "Pan blando y de corteza", "Panes europeos"]} duracionClase={"4 horas"} />
