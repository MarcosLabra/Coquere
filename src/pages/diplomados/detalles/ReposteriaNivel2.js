...
const ReposteriaNivel2 = () => {
  ...
  return (
    <main>
      ...
      <DiplomadosDetalle titulo={"Diplomado Básico de Repostería"} duracion={"6 clases"} clases={["Tartas", "Galletas", "Cupcakes", "Pasteles clásicos", "Pasteles Europeos", "Chocolatería"]} duracionClase={"4 horas"} portada={"/images/diplomados/reposteriaNivel2.png"} />
