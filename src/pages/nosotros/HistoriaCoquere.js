const HistoriaCoquere = () => {
    return (
        <section className="historiaCoquere">
            <h4  id="historiaCoquere">Nuestra histroria</h4>
            ...
            <p>Coquere es eso, cocinar en espacios cómodos que te hacen sentir como si cocinaras en casa, preparar algo que te va a salir, lo que puedes replicar y lo que puedes compartir.</p>
            <img src="/images/branding/coquereLogoNegro.svg" alt="Logo Coquere" />
        </section>
    )
}

export default HistoriaCoquere;
